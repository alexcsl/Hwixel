package edu.bluejack25_2.hwixel.data

import android.content.Context
import edu.bluejack25_2.hwixel.data.repository.AttendanceRepository
import edu.bluejack25_2.hwixel.data.repository.AttendanceRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.AuthRepository
import edu.bluejack25_2.hwixel.data.repository.AuthRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.EvalRepository
import edu.bluejack25_2.hwixel.data.repository.EvalRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.FileRepository
import edu.bluejack25_2.hwixel.data.repository.FileRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.NotificationRepository
import edu.bluejack25_2.hwixel.data.repository.NotificationRepositoryImpl
...
import edu.bluejack25_2.hwixel.data.repository.ProjectRepositoryImpl
...
import edu.bluejack25_2.hwixel.data.repository.TaskRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.TeamHealthRepository
import edu.bluejack25_2.hwixel.data.repository.TeamHealthRepositoryImpl
import edu.bluejack25_2.hwixel.data.repository.UserRepository
import edu.bluejack25_2.hwixel.data.repository.UserRepositoryImpl
import edu.bluejack25_2.hwixel.data.source.local.HwixelDatabase
import edu.bluejack25_2.hwixel.data.source.remote.AttachmentUploadSource
import edu.bluejack25_2.hwixel.data.source.remote.AttendanceFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.AuthFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.EvalFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.FileFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.GptApiSource
import edu.bluejack25_2.hwixel.data.source.remote.NotificationFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.ProjectFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.SupabaseStorageSource
import edu.bluejack25_2.hwixel.data.source.remote.TaskFirebaseSource
import edu.bluejack25_2.hwixel.data.source.remote.UserFirebaseSource
