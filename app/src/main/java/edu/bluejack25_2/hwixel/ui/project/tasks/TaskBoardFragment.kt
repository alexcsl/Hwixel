...
import edu.bluejack25_2.hwixel.databinding.FragmentTaskBoardBinding
import edu.bluejack25_2.hwixel.ui.project.hub.ProjectHubFragmentDirections
import edu.bluejack25_2.hwixel.ui.project.hub.ProjectPagerAdapter
import edu.bluejack25_2.hwixel.ui.project.hub.fillViewPagerPage
...
class TaskBoardFragment : Fragment() {
    ...
    private fun setupKanbanView() {
        fun bindColumn(columnBinding: edu.bluejack25_2.hwixel.databinding.LayoutKanbanColumnBinding, title: String, adapter: TaskCardAdapter) {
